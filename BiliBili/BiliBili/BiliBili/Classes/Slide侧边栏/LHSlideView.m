...
@interface LHSlideView() <UIGestureRecognizerDelegate,
...
@property (strong, nonatomic) UITableViewCell *last_cell;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([cell.textLabel.text isEqualToString:self.last_cell.textLabel.text]) {
        ...
        if ([cell.textLabel.text isEqualToString:@"    我的收藏"]) {
            ...
            LHHistoryController *vc = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"CollectionView"];
