...
@property (strong, nonatomic) NSMutableArray *danmakus;

@property (strong, nonatomic) NSMutableArray *currentDanmakus;

@property (strong, nonatomic) NSMutableArray *subDanmakuInfos;

@property (strong, nonatomic) NSMutableDictionary *linesDict;

@property (strong, nonatomic) NSMutableDictionary *centerTopLinesDict;

@property (strong, nonatomic) NSMutableDictionary *centerBottomLinesDict;
...
- (void)getCurrentTime{
    ...
    NSTimeInterval timeInterval = [self.delegate
        danmakuViewGetPlayTime:self];
...
- (UILabel *)drawingDanmu:(CFDanmaku *)danmaku{
    ...
    [danmaku.contentStr enumerateAttributesInRange:NSMakeRange(0, danmaku.contentStr.length) options:0
        usingBlock:^(NSDictionary<NSString *,id> * _Nonnull attrs, NSRange range, BOOL * _Nonnull stop) {
        
        dict = attrs;
    }];
    
    [str drawAtPoint:CGPointMake(0, 0) withAttributes:@{ NSFontAttributeName : [dict valueForKey:@"NSFont"], NSStrokeWidthAttributeName : @2.0,NSForegroundColorAttributeName : [UIColor blackColor] }];
