...
@property (strong, nonatomic) NSDictionary *extParam;
@end
...
//                            DYNSLog(@"headImage = %@ nickName = %@",[AcountManager manager].userHeadImageUrl,[AcountManager manager].userNickName);
//                            model.headImageURL = [NSURL URLWithString:[AcountManager manager].userHeadImageUrl];
//                            model.nickName = [AcountManager manager].userNickName;
//                        }
...
{
    NSDictionary *ext = self.extParam;
