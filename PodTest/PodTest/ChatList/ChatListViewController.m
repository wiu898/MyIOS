...
//    NSMutableArray *tranformArray = [[NSMutableArray alloc] init];
//    for (EMConversation *emconversation in sorte) {
//        emconversation.ext = emconversation.latestMessageFromOthers.ext;
//        [tranformArray addObject:emconversation];
//    }
