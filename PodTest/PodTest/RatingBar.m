...
- (void)setImageDeselected:(NSString *)deselectedName
    ...
    halfSelectedImage = halfSelectedName == nil ?
          unSelectedImage : [UIImage imageNamed:halfSelectedName];
    ...
    startRating = 0.0,lastRating = 0.0;
...
- (void)displayRating:(CGFloat)rating{
    ...
    startRating = rating;
    lastRating = rating;
    if ([_delegate respondsToSelector:@selector(rantingChanged:)]) {
