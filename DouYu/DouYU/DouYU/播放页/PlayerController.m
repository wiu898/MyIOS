...
- (void)initViewPager{
    ...
    NSArray *titles = [[NSArray alloc] initWithObjects:@"聊天",@"主播",@"排行",nil];
    
    NSArray *views = [[NSArray alloc] initWithObjects:_webView,_webView,_webView, nil];
    
    _viewPager = [[YFViewPager alloc] initWithFrame:CGRectMake(0, screen_width * 9 / 16+20, screen_width, screen_height-screen_width *9 / 16-20) titles:titles icons:nil selectedIcons:nil views:views];
