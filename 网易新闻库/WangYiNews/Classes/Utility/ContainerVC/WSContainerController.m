...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if (self.navigationController && self.tabBarController) {
        ...
        self.collectionView.frame = CGRectMake(0, topNav +
            self.navigationView.frame.size.height, width,
            height-self.navigationView.frame.size.height-bottomTab-topNav);
    }else{
...
+ (instancetype)containerControllerWithSubControlers:(NSArray<UIViewController *> *)viewControllers
