...
- (void)setTopicDetail:(WSTopicDetail *)topicDetail{
    ...
    [self.questionIcon sd_setImageWithURL:[NSURL
        URLWithString:topicDetail.question.userHeadPicUrl]
        placeholderImage:[UIImage imageNamed:@"comment_profile_default"]];
    
    self.questionTitleLbl.text = topicDetail.question.userName;
    self.quesitonLbl.text = topicDetail.question.content;
    
    [self.answerIcon sd_setImageWithURL:[NSURL
        URLWithString:topicDetail.answer.specialistHeadPicUrl]
        placeholderImage:[UIImage imageNamed:@"comment_profile_default"]];
