...
+ (void)commentWithID:(NSString *)ID index:(NSInteger)index type:(WSCommentType)type getDataSuccess:(GetDataSuccessBlock)success
       getDataFailure:(GetDataFailureBlock)failure;
