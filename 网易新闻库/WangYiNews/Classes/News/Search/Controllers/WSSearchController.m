...
@interface WSSearchController()<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([result.skipType isEqualToString:@"doc"]) {
        ...
        WSImageContentController *vc =
           [[WSImageContentController alloc] init];
        vc.replycount = 0;
